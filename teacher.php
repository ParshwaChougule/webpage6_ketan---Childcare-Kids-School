...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="col-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb d-flex align-items-center justify-content-center">
                                ...
                                <li class="breadcrumb-item active text-orange" aria-current="page">Teacher</li>
                            </ol>
                        </nav>
                    </div>
                </div>
       ...
       <section class="teacher1 pt-100 pb-100">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="teacher-image overflow-hidden position-relative text-center">
                        <img src="./assets/img/teacher-8 (1).jpg" alt="teacher-1" class="img-fluid rounded-circle ">
                        <div class="social-media">
                            <ul class="list-unstyled">
                                <li class="d-inline-block">
                                    <a href="javascript:void()">
                    ...
                    <div class="text-center">
                        <h3 class="fs-2">David Beckham</h3>
                        <h6 class="text-orange fs-6">Music Teacher</h6>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="teacher-image overflow-hidden position-relative text-center">
                        <img src="./assets/img/teacher-9 (1).jpg" alt="teacher-1" class="img-fluid rounded-circle ">
                        <div class="social-media">
                            <ul class="list-unstyled">
                                <li class="d-inline-block">
                                    <a href="javascript:void()">
                    ...
                    <div class="text-center">
                        <h3 class="fs-2">Jacinda Meri</h3>
                        <h6 class="text-orange fs-6">Art Teacher</h6>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="teacher-image overflow-hidden position-relative text-center">
                        <img src="./assets/img/teacher-10 (1).jpg" alt="teacher-1" class="img-fluid rounded-circle ">
                        <div class="social-media">
                            <ul class="list-unstyled">
                                <li class="d-inline-block">
                                    <a href="javascript:void()">
                    ...
                    <div class="text-center">
                        <h3 class="fs-2">Alex Maxwel</h3>
                        <h6 class="text-orange fs-6">Math Teacher</h6>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="teacher-image overflow-hidden position-relative text-center">
                        <img src="./assets/img/teacher-11 (1).jpg" alt="teacher-1" class="img-fluid rounded-circle ">
                        <div class="social-media">
                            <ul class="list-unstyled">
                                <li class="d-inline-block">
                                    <a href="javascript:void()">
                    ...
                    <div class="text-center">
                        <h3 class="fs-2">Carl Anderson</h3>
                        <h6 class="text-orange fs-6">English Teacher</h6>
                    </div>
                </div>
            </div>
