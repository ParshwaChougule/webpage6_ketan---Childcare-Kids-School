    ...
    <body>
        ...
        <section class="gallery">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="text-center text-white">Class</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb d-flex align-items-center justify-content-center">
                                ...
                                <li class="breadcrumb-item active text-orange" aria-current="page">Class</li>
                            </ol>
                        </nav>
                    </div>
                </div>
       ...
       <section class="popular  pt-100 pb-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    <div class="card overflow-hidden mt-4">
                        <div class="h-50 overflow-hidden">
                            <img src="./assets/img/class-4.jpg" class="card-img-top" alt="...">
                        </div>
                        <div class="card-body">
                            <div class="price">$880</div>
                            <h3 class="card-title fw-bold">Kids Painting Class</h3>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                            </p>
                            <ul class="list d-flex">
                ...
                <div class="col-lg-4">
                    <div class="card overflow-hidden mt-4">
                        <div class="h-50 overflow-hidden">
                            <img src="./assets/img/class-5.jpg" class="card-img-top" alt="...">
                        </div>
                        <div class="card-body">
                            <div class="price">$790</div>
                            <h3 class="card-title fw-bold">Martial Art Class</h3>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                            </p>
                            <ul class="list d-flex">
                ...
                <div class="col-lg-4">
                    <div class="card overflow-hidden mt-4">
                        <div class="h-50 overflow-hidden">
                            <img src="./assets/img/class-6.jpg" class="card-img-top" alt="...">
                        </div>
                        <div class="card-body">
                            <div class="price">$590</div>
                            <h3 class="card-title fw-bold">Music Class</h3>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                            </p>
                            <ul class="list d-flex">
