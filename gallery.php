            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="src">
                            <img src="./assets/img/gallery-1.jpg" alt="image" class="mb-5" style="border-radius: 5%;">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="src">
                            <img src="./assets/img/gallery-2.jpg" alt="image" class="mb-5" style="border-radius: 5%;">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="src">
                            <img src="./assets/img/gallery-3.jpg" alt="image" class="mb-5" style="border-radius: 5%;">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="src">
                            <img src="./assets/img/gallery-4.jpg" alt="image" class="mb-5" style="border-radius: 5%;">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="src">
                            <img src="./assets/img/gallery-5.jpg" alt="image" class="mb-5" style="border-radius: 5%;">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="src">
                            <img src="./assets/img/gallery-6.jpg" alt="image" class="mb-5" style="border-radius: 5%;">
                        </div>
                    </div>
                    <div>
                        <a href="javascript:void()" class="btn" style="margin-left: 44%;">View More</a>
                    </div>
                </div>
            </div>
        </section>
